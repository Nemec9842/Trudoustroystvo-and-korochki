...
--
-- Хост: localhost
-- Время создания: Сен 22 2026 г., 12:02
...
CREATE TABLE `kursi` (
  ...
  `nazvanie_kursa` varchar(255) NOT NULL
...
INSERT INTO `kursi` (`id_kursi`, `nazvanie_kursa`) VALUES
...
ALTER TABLE `zayvka`
  ...
  ADD KEY `otzivi_id` (`otziv_id`),
  ADD KEY `kursi_id` (`kursi_id`),
  ADD KEY `oplati_id` (`oplati_id`),
...
--
ALTER TABLE `zayvka`
  ADD CONSTRAINT `fk_zayvka_otziv` FOREIGN KEY (`otziv_id`) REFERENCES `otziv` (`id_otziv`),
  ADD CONSTRAINT `zayvka_ibfk_1` FOREIGN KEY (`polzovateli_id`) REFERENCES `polzovateli` (`id_polzovateli`),
  ADD CONSTRAINT `zayvka_ibfk_2` FOREIGN KEY (`status_id`) REFERENCES `statusi` (`id_statusi`),
  ADD CONSTRAINT `zayvka_ibfk_3` FOREIGN KEY (`kursi_id`) REFERENCES `kursi` (`id_kursi`),
  ADD CONSTRAINT `zayvka_ibfk_4` FOREIGN KEY (`oplati_id`) REFERENCES `oplati` (`id_oplati`);
COMMIT;
